...
namespace Battlehub.HorizonBending
{
    ...
    public class HBFixBounds : MonoBehaviour
    {
        ...
        public Vector3 Flatten = Vector3.zero;
        public Vector3 HorizonOffset = Vector3.zero;
        ...
        {
            HBSettings settings = new HBSettings(BendingMode, Curvature * HB.CURVATURE_FACTOR, Flatten, HorizonOffset, false);
